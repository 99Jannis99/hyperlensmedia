...
(() => {
  ...
  var init_IX2VanillaUtils = __esm({
    "packages/systems/ix2/shared/logic/IX2VanillaUtils.ts"() {
      ...
      processElementByType = ({ effect, actionTypeId, elementApi }) =>
          ...
          case IX2_INSTANCE_ADDED3: {
            ...
            const destinationKeys = Object.keys(destination).filter(
              (key) =>
                ...
                destination[key] != null && typeof destination[key] !== "string" // Skip string destination values
            );
  ...
  var init_IX2VanillaEvents = __esm({
    "packages/systems/ix2/engine/logic/IX2VanillaEvents.ts"() {
      ...
      whenComponentActiveChange = (handler) => (options, oldState) => { // @ts-expect-error - TS7006 - Parameter 'handler' implicitly has an 'any' type.
      ...
      whenScrollDirectionChange = (handler) => (options, oldState = {}) => { // @ts-expect-error - TS7006 - Parameter 'handler' implicitly has an 'any' type.
        const {
      ...
      whenClickCountChange = (handler) => (
        options,
        oldState = { clickCount: 0 }
      ) => {
        const newState = {
  ...
  function handleInstanceChange(instance, store) {
    ...
    if (continuous || active || complete) {
      if (current || (renderType === RENDER_GENERAL4 && complete)) {
        ...
        const { ixElements: ixElements3 } = store.getState();
        const { ref, refType, refState: refState2 } =
...
Webflow.require("ix2").init({
  events: {
    e: {
      ...
      target: {
        id: "66aa136e9a9ec8aec249379e|7d17e60d-1eeb-cba8-5637-e6f9bf51b2d5",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-3": {
      ...
      mediaQueries: ["main"],
      target: {
        id: "66aa136e9a9ec8aec249379e|7d17e60d-1eeb-cba8-5637-e6f9bf51b2e1",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-13": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66aaaabaa16cc03fe949dc4c|95dcaf3c-9b03-c12a-6965-961ea4c56f70",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-14": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66aaaabaa16cc03fe949dc4c|95dcaf3c-9b03-c12a-6965-961ea4c56f44",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-15": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66aaaabaa16cc03fe949dc4c|95dcaf3c-9b03-c12a-6965-961ea4c56f5a",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-16": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66aaaabaa16cc03fe949dc4c|95dcaf3c-9b03-c12a-6965-961ea4c56f65",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-17": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "66aaaabaa16cc03fe949dc4c|95dcaf3c-9b03-c12a-6965-961ea4c56f4f",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
  ...
  actionLists: {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["f4696956-292a-4867-8e52-101c7e1dc1b0"],
                },
                widthValue: 0,
                widthUnit: "px",
                heightUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["f4696956-292a-4867-8e52-101c7e1dc1b1"],
                },
                yValue: -8,
                xUnit: "PX",
                yUnit: "px",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["f4696956-292a-4867-8e52-101c7e1dc1b4"],
                },
                yValue: 8,
                xUnit: "PX",
                yUnit: "px",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".navbar5_dropdown-list",
                  selectorGuids: ["f4696956-292a-4867-8e52-101c7e1dc1a8"],
                },
                value: 0,
                unit: "",
              },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["f4696956-292a-4867-8e52-101c7e1dc19e"],
                },
                zValue: 180,
                xUnit: "DEG",
                yUnit: "DEG",
    ...
    "a-5": {
      id: "a-5",
      title: "Navbar 5 dropdown [Open] [Tablet]",
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    "a-6": {
      id: "a-6",
      title: "Navbar 5 dropdown [Close] [Tablet]",
      actionItemGroups: [
        {
          actionItems: [
            {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: ".drone-garage_faq_answer",
                  selectorGuids: ["64353755-dfd8-6f23-80a5-7c51d8360fdd"],
                },
                heightValue: 0,
                widthUnit: "PX",
                heightUnit: "px",
          ...
          actionItems: [
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".drone-garage_faq_icon-wrapper",
                  selectorGuids: ["64353755-dfd8-6f23-80a5-7c51d8360fdc"],
                },
                zValue: 45,
                xUnit: "DEG",
                yUnit: "DEG",
